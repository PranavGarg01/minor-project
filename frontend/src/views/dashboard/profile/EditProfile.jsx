      ...
      <Grid item container md={6} sm={12} style={{ marginTop: '3rem' }}>
        ...
        >
          <CardHeader>
            ...
            <CardTitle
              tag='small'
              style={{ fontSize: '3.5rem', lineHeight: 'none' }}
            >
              Edit Profile
            </CardTitle>
          </CardHeader>
          <Form onSubmit={onSubmit} className='form'>
            <CardBody>
              <Grid item xs={12}>
                <FormControl style={{ width: '100%', margin: '11px auto' }}>
                  <InputLabel
                    style={{
                      fontFamily: 'Poppins',
                      fontWeight: 'bold',
              ...
              <Grid item xs={12}>
                <FormControl style={{ width: '100%', margin: '18px auto' }}>
                  <InputLabel
                    style={{
                      fontFamily: 'Poppins',
                      fontWeight: 'bold',
                  ...
                  >
                    {historyArray.map((history) => (
                      <MenuItem key={history} value={history}>
                        <Checkbox
                          checked={medicalHistory.indexOf(history) > -1}
                        />
                  ...
                  >
                    {deficiencyArray.map((allergy) => (
                      <MenuItem key={allergy} value={allergy}>
                        <Checkbox checked={deficiency.indexOf(allergy) > -1} />
